...
const GlobeModel = dynamic(() => import('../../GlobeModel'), { ssr: false })
    ...
    Have something in mind? Send a message and let's connect.
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full flex items-center justify-center rounded-[28px] overflow-hidden border border-white/10"
...
<div className="mt-20 text-center text-xs text-white/35">
  © 2026 Emirhan Arıkan — All rights reserved.
</div>
    </section>
  )
}