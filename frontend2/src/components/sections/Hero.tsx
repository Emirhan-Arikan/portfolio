    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <TextType
              text={["AI & Data Engineering Student", "Machine Learning Enthusiast", "Building Intelligent Systems"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            Yapay Zeka ve Veri Mühendisliği öğrencisi olarak, makine öğrenmesi ve derin öğrenme projeleri geliştiriyorum. 
            PyTorch ve Scikit-learn ile model eğitimi, Django ile web uygulamaları ve C/C++ ile sistem programlama konularında deneyimliyim.
          </p>
        </motion.div>
